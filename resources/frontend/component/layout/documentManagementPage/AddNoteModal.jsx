                    ...
                    try {
                        ...
                        if (
                            ...
                            if (
                                ...
                                console.warn(
                                    "API for submilestones (AddNoteModal) did not return an array. Received:",
                                    response.data
                                );
                            }
                            setError(
                                `Failed to load document types: ${receivedInfo} Please contact support if this issue persists.`
                            );
                            setSubmilestoneOptions([]);
                        }
                    } catch (err) {
                        console.error(
                            "Failed to fetch submilestone options (AddNoteModal):",
                            err
                        );
                        ...
                        if (err.response) {
                            ...
                            if (
                                ...
                                userErrorMessage =
                                    "Failed to load document types: Server returned an unexpected page.";
                            } else if (
                                err.response.data &&
