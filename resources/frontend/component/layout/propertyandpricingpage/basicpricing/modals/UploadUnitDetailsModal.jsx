            ...
            <div className=' px-14 mb-5 rounded-[10px]'>
                ...
                <div className="flex flex-col gap-2">
                    <div className="flex items-center border border-custom-grayF1 rounded-md overflow-hidden">
                        <span className="text-custom-gray81 bg-custom-grayFA flex items-center w-[450px] h-[31px] -mr-3 pl-3 text-sm">Floor</span>
                ...
                <div className='flex justify-center mt-4 mb-8'>
                    <button className='w-[177px] h-[37px] text-white montserrat-semibold text-sm gradient-btn2 rounded-[10px] hover:shadow-custom4'>Confirm and Upload</button>
                </div>
            </div>
        </dialog>
  )
