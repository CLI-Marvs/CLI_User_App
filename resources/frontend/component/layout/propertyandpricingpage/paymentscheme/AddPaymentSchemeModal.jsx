                ...
                <div className="flex flex-col gap-2">
                    ...
                    <div className="flex items-center border border-custom-grayF1 rounded-md overflow-hidden">
                        ...
                        <div className="relative w-full">
                            <select name="discountedFromSelect" className="appearance-none w-[200px] px-4 py-1 bg-white text-gray-400 focus:outline-none border-0">
                                <option value=""></option>
                    ...
                    <div className='flex justify-center gap-[10px] my-3'>
                        <button className='w-[173px] h-[37px] text-white montserrat-semibold text-sm gradient-btn2 rounded-[10px]'>Submit for Approval</button>
