...
const PaymentScheme = () => {
  ...
  return (
    <div className='h-screen max-w-[1800px] bg-custom-grayFA px-4'>
          <div className=''>
            <button onClick={handleOpenModal} className='montserrat-semibold text-sm px-2 gradient-btn2 w-[192px] h-[37px] rounded-[10px] text-white'>Add Payment Scheme</button>
          </div>
            ...
            <table className='overflow-x-auto bg-custom-grayFA mb-2 mx-1'>
              <thead>
                <tr className='flex gap-[30px] items-center h-[49px] montserrat-semibold text-sm text-[#A5A5A5] bg-white rounded-[10px] mb-4 -mx-1 px-4'>
                  ...
                  <th className='flex justify-start w-[100px] shrink-0 pl-1'>spot</th>
                  <th className='flex justify-start w-[100px] shrink-0 pl-1'>Installment/No. Months</th>
                  <th className='flex justify-start w-[100px] shrink-0 pl-1'>Bank Fianancing</th>
                  <th className='flex justify-start w-[120px] shrink-0 pl-1'>Discount</th>
                </tr>
              </thead>
              <tbody className='mt-{10px} rounded-[10px]'>
                <tr className='flex min-h-[68px]  shadow-custom4 text-sm justify-start gap-[30px] px-[12px] bg-white  rounded-t-[10px]'>
                  ...
                  <td className='flex items-center w-[200px] pr-3 py-3'>
                    <p>Spot Cash TCP with 8% discount on List Price (net of Rf)</p>
                  </td>
                ...
                <tr className='flex min-h-[68px]  shadow-custom4 text-sm justify-start gap-[30px] px-[12px] bg-custom-grayFA'>
                  <td className='flex flex-col justify-center w-[100px] pr-3 py-3'>
                      ...
                      <p>3/3/2024</p>
                      <div className=''>
                        <p className='underline cursor-pointer text-blue-500'>Edit</p>
                      </div>
                  </td>
                  <td className='flex items-center w-[150px]'>
                    <p>Spot 12% DP</p>
                  ...
                  <td className='flex items-center w-[200px] pr-3 py-3'>
                    <p>Spot 12% DP on TCP with 5% Discount on LP (net of RF)</p>
                  </td>
                  <td className='flex items-center w-[100px]'>
                    <p>12%</p>
                  </td >
                ...
                <tr className='flex min-h-[68px]  shadow-custom4 text-sm justify-start gap-[30px] px-[12px] bg-white'>
                  <td className='flex flex-col justify-center w-[100px] pr-3 py-3'>
                      ...
                      <p>3/3/2024</p>
                      <div className=''>
                        <p className='underline cursor-pointer text-blue-500'>Cancel</p>
                      </div>
                  </td>
                  <td className='flex items-center w-[150px]'>
                    <p>Spot 2% DP</p>
                  ...
                  <td className='flex items-center w-[200px] pr-3 py-3'>
                    <p>Spot 2% DP on TCP with 10% Discount on 2% LP</p>
                  </td>
                  <td className='flex items-center w-[100px]'>
                    <p>2%</p>
                  </td >
