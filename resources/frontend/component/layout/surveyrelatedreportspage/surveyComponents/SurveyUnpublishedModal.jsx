...
const SurveyUnpublishedModal = ({modalRef, unpublish}) => {
    return (
        <dialog
            id="SurveyUnpublish"
        ...
        >
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                <div className="flex flex-col justify-center bg-white rounded-lg shadow-lg p-6 w-[400px] h-[200px] text-center">
                    <h2 className="text-lg montserrat-semibold mb-4">Confirm Unpublish</h2>
                    <p className="text-sm mb-6 montserrat-medium">Are you sure you want to unpublish this?</p>
...
export default SurveyUnpublishedModal