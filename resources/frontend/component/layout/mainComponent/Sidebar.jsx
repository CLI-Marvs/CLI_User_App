...
const Sidebar = () => {
    ...
    useEffect(() => {
        if (
            location.pathname.startsWith("/transactionmanagement/invoices") ||
                ...
                <List className="p-0 gap-0">
                  ...
                  ${
                    ...
                    <Link to="/transactionmanagement/invoices">
                        <ListItem
                            className={`h-[35px] w-[200px] text-sm pl-[12px] transition-all duration-300 ease-in-out 
      ${
      ...
      `}
                    ...
                    {isInvoiceOpen &&
                        location.pathname.startsWith(
                            ...
                            <div className="px-[12px] py-[20px] w-[200px] min-h-[122px] flex flex-col gap-[5px] bg-custom-lightestgreen border-t rounded-t-none rounded-b-[10px] border-custom-solidgreen transition-all duration-300 ease-in-out">
                                <Link to="/transactionmanagement/invoices">
                                    <ListItem
                                        className={`h-[32px] w-full py-[8px] px-[18px] text-sm rounded-[50px] ${
                                            location.pathname.startsWith(
