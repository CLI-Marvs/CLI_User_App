        ...
        <div className='flex w-[968px] gap-[50px]'>
          <div className='w-[463px] flex flex-col'>
            ...
            <div className='w-full bg-white mt-[24px] shadow-custom5 rounded-[10px] '>
                <p className='m-1 bg-[#F5F5F5] rounded-[10px] px-[12px] text-sm montserrat-medium'>Payed using:</p>
              <EWallet />
          ...
          <div className='w-[455px] flex flex-col bg-custom-solidgreen rounded-[10px] '>
            <div className='mx-[30px] my-[25px] h-[76px] flex justify-start items-center'>
             
                <p className='montserrat-semibold text-[36px] text-white'>PAYED!</p>
