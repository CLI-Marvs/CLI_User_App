            ...
            <div className={` transition-all duration-300`}>
                ...
                >
                    ...
                    <div className='flex flex-col w-[345px] items-start'>
                        ...
                        <span className="montserrat-medium text-xs text-custom-gray81">Use your credit card for flexible payment terms</span>
                    </div>
                ...
                {isOpen && (
                    <div className="">
                        <div className='w-full h-[50px] px-[35px] py-[10px] bg-[#F4F3F3]'>
                            <p className='montserrat-medium text-xs text-custom-gray81'>Select the issuingbank of you credit card, and you will be prompted to select payment terms.</p>
                        </div>
