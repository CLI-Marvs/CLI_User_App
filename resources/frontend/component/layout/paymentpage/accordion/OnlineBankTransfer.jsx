            ...
            <div className={` transition-all duration-300`}>
                ...
                >
                    ...
                    <div className='flex flex-col w-[345px] items-start'>
                        ...
                        >
                            use your existing bank account tot pay securely
                        </span>
                    </div>
                ...
                {isOpen && (
                    <div className="">
                        <div className='w-full px-[35px] py-[10px] bg-[#F4F3F3]'>
                            <p className='montserrat-medium text-xs text-custom-gray81'>Please select your preferred bank below, and you will be redirected to bank’s internet banking portal to authorize payment.</p>
                        </div>
