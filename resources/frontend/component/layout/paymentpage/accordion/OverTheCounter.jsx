            ...
            <div className={` transition-all duration-300`}>
                ...
                >
                    ...
                    <div className='flex flex-col w-[345px] items-start'>
                        ...
                        <span 
                        className="montserrat-medium text-xs text-custom-gray81"
                        >
                            Go and pay in cash at the cashier
                        </span>
                    </div>
                ...
                {isOpen && (
                    <div className="">
                        <div className='w-full px-[35px] py-[10px] bg-[#F4F3F3]'>
                            <p className='montserrat-medium text-xs text-custom-gray81'>A reference number will be generated which will be presented to the cashier during cash payment.</p>
                        </div>
                        <div className='h-[35px] w-full py-[10px] px-[35px] montserrat-medium text-xs text-custom-blue border-b border-[#F4F3F3]'>
                            Pay at any supported over the counter channels
                        </div>
                        <div className='h-[68px] w-full px-[35px] pl-[35px] flex justify-start items-center gap-[40px] border-b border-[#F4F3F3]'>
                            <input name='bank' type="radio" />
                            <div className='flex flex-col'>
                                <p className='font-semibold text-xs'>Pay at any payment channel listed below</p>
                                <p className='text-xs text-custom-gray81'>Recommended. Gives you flexible options to pay at any channel.</p>
                            </div>
                        </div>
                        <div className='h-[35px] w-full py-[10px] px-[35px] montserrat-medium text-xs text-custom-blue border-b border-[#F4F3F3]'>
                            Pay at specific over the counter channels
                        </div>
                        ...
                        <div className='relative h-[76px] w-full px-[35px] pl-[35px] flex justify-start items-center gap-[20px] border-b border-[#F4F3F3]'>
                            <p className='absolute right-0 top-0 w-[102px] h-[20px] py-[4px] px-[10px] rounded-bl-[6px] bg-[#FA7000] montserrat-medium text-white text-[10px]'>MAINTAINANCE</p>
