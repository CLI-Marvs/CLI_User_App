            ...
            <div className={` transition-all duration-300`}>
                ...
                >
                    ...
                    <div className='flex flex-col w-[345px] items-start'>
                        ...
                        <span className="montserrat-medium text-xs text-custom-gray81">Use your installment partners for flexible payment terms</span>
                    </div>
                ...
                {isOpen && (
                    <div className="">
                        <div className='w-full px-[35px] py-[10px] bg-[#F4F3F3]'>
                            <p className='montserrat-medium text-xs text-custom-gray81'>Select an installment provider below, and you will be redirected to another page to authorize payment. Please note that you must have an existing account on the provider that you will  choose.</p>
                        </div>
...
export default InstallmentNonCredit