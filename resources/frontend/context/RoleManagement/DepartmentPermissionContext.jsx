...
export const DepartmentPermissionProvider = ({ children }) => {
    ...
    const [departmentsWithPermissions, setDepartmentsWithPermissions] = useState(null);
...
const useDepartmentPermission = () => {
    ...
    if (!context) {
        throw new Error('useDepartmentPermissionTest must be used within a DepartmentPermissionContextProvider');
    }
    return context;
};
