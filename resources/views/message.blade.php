...
<head>
    ...
    <style>
        ...
        body {
            ...
            padding: 0;
            /* Remove padding to better center content */
            margin: 0;
...
<body
    style="font-family: Verdana, Arial, sans-serif; background-color: #EAF0F3; padding: 0; margin: 0; text-align: center;">
    <table align="center" width="100%" cellpadding="0" cellspacing="0" border="0"
        style="max-width: 1000px; padding: 40px;">
        <tr>
            <td>
                <div style="margin-top: 10px;">
                    <p style="font-family: Verdana, Arial, sans-serif; font-size: 30px; line-height: 30px;">
                        {{ $details_message }}
                    </p>
                </div>
            </td>
