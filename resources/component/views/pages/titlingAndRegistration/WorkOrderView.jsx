...
import Edit from "@/assets/images/Subtract.svg";
import Delete from "@/assets/images/Trash_light.svg";
...
const WorkOrderView = () => {
    ...
    const handleSoftDeleteWorkOrder = async (workOrderId, reason) => {
        ...
        try {
            ...
            alert(
                `Failed to delete work order: ${error.message || "Please try again."
                }`
            );
            throw error;
        } finally {
    ...
    const handleSoftDeleteWorkOrderGroup = async (groupId, reason) => {
        ...
        try {
            ...
            alert(
                `Failed to delete work order group: ${error.message || "Please try again."
                }`
            );
            throw error;
        } finally {
            ...
            <div className="relative flex items-center gap-1.5 mb-2 w-full">
                ...
                <div className="flex gap-1.5 flex-shrink-0">
                    <button
                        ...
                        className="h-[47px] w-[120px] px-3 bg-[#067AC5] font-semibold text-white text-sm rounded-[10px] flex items-center justify-center gap-2 transition-all duration-200"
