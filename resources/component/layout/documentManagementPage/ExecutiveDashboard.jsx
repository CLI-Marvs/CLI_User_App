...
import EmployeeEvaluationModal from "./EmployeeEvaluationModal.jsx";
                    ...
                    <div className="flex border-b border-gray-200">
                        {["week", "month", "quarter"].map((range) => (
                            <button
                                ...
                                className={`px-4 py-2 text-xs font-medium ${timeRange === range
                                        ...
                                        (row) => (
                                            ...
                                            >
                                                ...
                                                <td className="px-4 py-4 whitespace-nowrap">
                                                    <span
                                                        className={`px-2 py-1 text-xs font-semibold rounded-full capitalize ${row.status ===
                                                                "Complete"
                                                ...
                                                <td className="px-4 py-4 whitespace-nowrap">
                                                    <div className="w-28">
                                                        ...
                                                        <div className="w-full bg-gray-200 rounded-full h-1.5">
                                                            <div
                                                                className={`h-1.5 rounded-full ${row.daysOpen >
                                                                        14
                                                                        ? "bg-red-500"
                                                                        : row.daysOpen >
                                                                            7
