...
import { useTransactionContext } from "frontend/context/Transaction/TransactionContext";
import ReactPaginate from "react-paginate";
import { MdKeyboardArrowLeft, MdKeyboardArrowRight } from "react-icons/md";
import { transaction } from "frontend/component/servicesApi/apiCalls/transactions";
import TransactionSearchBar from "frontend/component/layout/transaction/TransactionSearchBar";
import Skeletons from "frontend/component/Skeletons";
import { usePropertyFormatter } from "frontend/component/layout/transaction/hooks/usePropertyFormatter";
            ...
            header: (
                <>
                    <div className="flex gap-5 items-center relative">
                        ...
                        <label
                            htmlFor="select-all"
                            className={`w-6 h-6 border-[#FFFFFF] peer-checked:bg-[#FFFFFF] rounded-sm peer-checked:text-[#348017] cursor-pointer flex items-center justify-center ${isSelectedAll ? "" : "border-2"
                                }`}
                        >
                            {isSelectedAll && (
                                <svg
                ...
                return (
                    <div className="w-[100px]">
                        ...
                        <label
                            ...
                            className={`w-6 h-6 border-[#348017] peer-checked:bg-[#348017] rounded-sm peer-checked:text-white cursor-pointer flex items-center justify-center ${isChecked ? "" : "border-2"
                                }`}
                        >
                            {isChecked && (
                                <svg
