...
import { paymentSchemeService } from "frontend/component/servicesApi/apiCalls/propertyPricing/paymentScheme/paymentSchemeService";
import { showToast } from "frontend/util/toastUtil";
import CircularProgress from "@mui/material/CircularProgress";
import isButtonDisabled from "frontend/util/isFormButtonDisabled";
import { usePaymentScheme } from "frontend/context/PropertyPricing/PaymentSchemeContext";
            ...
            <div className=" px-14 mb-5 rounded-lg">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <div className="flex justify-center gap-[10px] my-3">
                        <button
                            className={`w-[173px] h-[37px] text-white montserrat-semibold text-sm gradient-btn2 rounded-[10px] hover:shadow-custom4  ${isPaymentSchemeButtonDisabled ||
